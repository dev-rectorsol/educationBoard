    ...
    <!-- Start Video Area
    ============================================= -->
    <div class="video-area padding-xl text-center bg-fixed text-light shadow dark-hard" style="background-image: url(<?php echo base_url() ?>assets/web/img/banner/16.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                            ...
                            <div id="portfolio-grid" class="portfolio-items col-3">
                                <div class="pf-item ceremony students">
                                    <div class="item-effect">
                                        <img src="<?php echo base_url('assets/web') ?>/img/gallery/1.jpg" alt="thumb" />
                                        <div class="overlay">
                                ...
                                <div class="pf-item teachers ceremony">
                                    <div class="item-effect">
                                        <img src="<?php echo base_url('assets/web') ?>/img/gallery/2.jpg" alt="thumb" />
                                        <div class="overlay">
                                ...
                                <div class="pf-item campus education">
                                    <div class="item-effect">
                                        <img src="<?php echo base_url('assets/web') ?>/img/gallery/3.jpg" alt="thumb" />
                                        <div class="overlay">
                                ...
                                <div class="pf-item education students">
                                    <div class="item-effect">
                                        <img src="<?php echo base_url('assets/web') ?>/img/gallery/4.jpg" alt="thumb" />
                                        <div class="overlay">
                                ...
                                <div class="pf-item ceremony campus">
                                    <div class="item-effect">
                                        <img src="<?php echo base_url('assets/web') ?>/img/gallery/5.jpg" alt="thumb" />
                                        <div class="overlay">
                                ...
                                <div class="pf-item ceremony teachres">
                                    <div class="item-effect">
                                        <img src="<?php echo base_url('assets/web') ?>/img/gallery/6.jpg" alt="thumb" />
                                        <div class="overlay">
