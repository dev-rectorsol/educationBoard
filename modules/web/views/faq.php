   <!-- Start Breadcrumb 
    ============================================= -->
    <div class="breadcrumb-area shadow dark text-center bg-fixed text-light" style="background-image: url(<?php echo base_url('assets/web/')?>img/banner/10.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>Faq</h1>
                            ...
                            <div class="sidebar-item recent-post">
                                ...
                                <div class="item">
                                    <div class="content">
                                        <div class="thumb">
                                            <a href="#">
                                                <img src="<?php echo base_url('assets/web')?>/img/courses/g1.jpg" alt="Thumb">
                                            </a>
                                        </div>
                                        <div class="info">
                                            <h4>
                                ...
                                <div class="item">
                                    <div class="content">
                                        <div class="thumb">
                                            <a href="#">
                                                <img src="<?php echo base_url('assets/web')?>/img/courses/g2.jpg" alt="Thumb">
                                            </a>
                                        </div>
                                        <div class="info">
                                            <h4>
